...
// @Id RegisterUser
// @Tags User
// @Param register body models.ReqUserRegister true "all fields mandatory. ex: (Birthday format DD-MM-YYYY)"
// @Success 200 {object} models.ResponseSuccess "token: "User Successfully Registered" "
// @Failure 422 {object} models.ResponseErrors "code: 422, message: "Invalid request" "
// @Failure 401 {object} models.ResponseErrors "code: 401, message: "Invalid Email Format" "
...
func (u UserController) Register(c *fiber.Ctx) error {
	...
	return models.ResponseJSON(c, fiber.Map{"message": "User Successfully Registered"})
}
...
// @Tags User
// @Security Token
// @Success 200 {object} models.ResponseSuccess "exampledeviceid"
// @Failure 422 {object} models.ResponseErrors "code: 422, message: "Invalid request" "
// @Failure 401 {object} models.ResponseErrors "code: 401, message: "device ID not found" "
